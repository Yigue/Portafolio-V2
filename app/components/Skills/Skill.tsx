...
<div
  className="rounded-xl left-0 h-[1px] animate-[borderWidths_3s_infinite_alternate]  bg-gradient-to-r from-[rgba(17,17,17,0)]
via-white to-[rgba(17,17,17,0)] transition-all duration-1000"
/>
</div> */
}
export default function Skills() {
  return (
    <section
      id="MisHabilidades"
      className=" flex  flex-col mt-24  font-mono px-[5%] lg:px-[10%] w-[75vw] m-auto"
    >
      ...
      <section className="grid grid-cols-2 grid-rows-2 gap-10 mt-10 ">
        <section className="border-zinc-800 border rounded-lg">
          <p
            className="backdrop-blur-sm   rounded-xl font-mono text-xl  text-center"
            key="FrontEnd"
          >
            FrontEnd
          </p>
        ...
        <section>
          ...
          <div className=" grid grid-cols-2 gap-y-16 p-3   items-center self-center justify-center  backdrop-blur-sm dark:backdrop-blur-sm rounded-3xl">
            <div className=" flex flex-col items-center    justify-center hover:scale-125  hover:text-orange-500 ">
              <AiFillHtml5 className="h-[50%] w-[15%]  "></AiFillHtml5>
              <div className="">HTMl</div>
            </div>
        ...
        <section>
          <p
            className="backdrop-blur-sm  rounded-xl font-mono text-xl
      text-center
          "
            key="BackEnd"
          >
