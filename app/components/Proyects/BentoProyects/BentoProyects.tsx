  ...
  return (
    <>
      <div className="flex flex-col max-lg:w-[80vw] m-auto  items-center justify-center lg:p-6 p-2 pt-10 text-slate-400/0 xl:text-slate-400">
        <div className="w-full grid lg:grid-cols-10 lg:grid-row-4 lg:gap-0  grid-cols-1 gap-10   ">
          <CardProyect
            id={10}
            className={"lg:col-span-5 lg:row-span-2 row-span-1  "}
            title="Ecommerce"
            image="Eccomers.png"
            imageClassName="lg:w-[80%] lg:h-[15rem] h-[20rem]   w-[15rem] m-auto "
          ...
          <CardProyect
            id={10}
            className={"lg:col-span-5  row-span-1 col-span-1 h-[20rem] grow "}
            title="ConseCar"
          ...
          <CardProyect
            ...
            title="Spotruck"
            image="Spotruck.jpg"
            descript="Spotruck fue mi proyecto de tesis para egresarme. Es una aplicación para la publicación y licitación de servicios logísticos, que busca ser el intermediario entre camioneros y entidades que requieren logística, facilitando la comunicación, mejorando la competitividad y reduciendo el tiempo de búsqueda."
            href={new URL("/", "http://www.spotruck.com.ar")}
            tecnologias={["PHP", "HTML", "CSS", "Materialize", "JavaScript"]}
            imageClassName="lg:w-[80%] lg:h-[15rem] h-[20rem] w-[15rem] overflow-hidden m-auto  "
          />
            <CardProyect
            id={10}
            className={"lg:col-span-5  h-[20rem] grow "}
            title="Stock Manager"
